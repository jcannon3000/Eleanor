        ...
        <div className="max-w-lg mx-auto px-4 py-12">
          ...
          >
            ...
            <div className="text-center space-y-3">
              ...
              <div>
                ...
                <h2 className="font-serif text-3xl text-foreground">
                  {unavailable ? "Got it." : "Preference shared."}
                </h2>
              </div>
            </div>
            ...
            {unavailable ? (
              <div className="bg-card border border-card-border rounded-2xl p-5 text-center">
                <p className="text-sm text-muted-foreground leading-relaxed">
                  {data?.organizerName} has been notified that this round doesn't work for you.
                  You'll be included in the next one.
                </p>
              </div>
            ) : (
              <div className="bg-card border border-card-border rounded-2xl p-5 space-y-3">
                {selectedTime && (
                  <div>
                    <p className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-1">Your availability</p>
                ...
                <div className="pt-2 border-t border-border/50">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      {data?.organizerName}'s calendar has been updated with your preference.
            ...
            <div className="bg-card border border-card-border rounded-2xl p-5">
              <p className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-2">The circle</p>
              <p className="font-medium text-foreground mb-1">{data?.ritualName}</p>
